...
class ServerMenuTest {
    ...
    fun serverMenuTest() {
        ...
        appCompatEditText.perform(replaceText("meierl"), closeSoftKeyboard())
        ...
        appCompatEditText3.perform(replaceText("TUGRAZ"), closeSoftKeyboard())
        ...
        val checkedTextView = onView(
            allOf(
                withId(android.R.id.text1), withText("TUGRAZ <news.tugraz.at>"),
